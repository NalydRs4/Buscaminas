            ...
            try {
                if (!modoBandera && PadreBuscaminas.getEncontradas()[fila][columna]) {
                    throw new CasillaYaDescubiertaException(
                            "[Aviso] Esa casilla ya esta descubierta. Elige otra.");
                }
                if (modoBandera) {
                    ...
                    System.out.println(
                            "[Aviso] Celda protegida por bandera. Quitala en el menu si deseas pisarla.");
        ...
        while (true) {
            try {
                ...
                if (opcion == 1 || opcion == 2) {
                    ...
                    System.out.println("[Error] Opcion invalida. Elige 1, 2 o 3.\n");
                }
